...
public class FrontRotor {
    ...
    public FrontRotor(int rotorId, int notchPosition, int amountOfEntriesInRotor, ArrayList<Character> forwardEntry, ArrayList<Character> backwardEntry) {
